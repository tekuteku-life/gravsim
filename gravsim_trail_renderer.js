 ...
 *******************************************************************/
class TrailLineRenderer {
	static draw(ctx, pointsToDraw, trajectory, renderContext) {
...
/*******************************************************************
 * CompositeTrailRenderer: Orchestrates multiple renderers
 *******************************************************************/
export class TrailRenderer {
	static draw(trajectory, renderContext) {
		...
		// Execute each effect renderer
		TrailLineRenderer.draw(ctx, pointsToDraw, trajectory, renderContext);
		SmokeEffectRenderer.draw(ctx, pointsToDraw, trajectory, renderContext);
		SparkEffectRenderer.draw(ctx, pointsToDraw, trajectory, renderContext);
	}
